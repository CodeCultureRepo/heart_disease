...
def user_input():
    ...
    fbs = st.selectbox('Is the patients blood sugar > 120 mg/dl:', ['False', 'True'])
    ...
    ca = st.selectbox('Number of Major Vessels Colored by Fluoroscopy:', ['Mild', 'Moderate', 'Severe'])
    thal = st.selectbox('What is the status of the heart:', ['Normal', 'Fixed defect', 'Reversible defect'])
